...
<template>
    <div>
        <div class="min-h-screen bg-gray-100 light:bg-gray-900">
            <nav class="bg-white light:bg-gray-800 border-b border-gray-100 light:border-gray-700">
                        ...
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('dashboard')">
                                    <ApplicationLogo
                                        class="block h-9 w-auto fill-current text-gray-800 light:text-gray-200"
                                    />
                                </Link>
                            </div>
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 light:text-gray-400 bg-white light:bg-gray-800 hover:text-gray-700 light:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150"
                                            >
            ...
            <!-- Page Heading -->
            <header class="bg-white light:bg-gray-800 shadow" v-if="$slots.header">
